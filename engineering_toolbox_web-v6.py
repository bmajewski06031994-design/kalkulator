...
# Set Page Config
st.set_page_config(
    page_title="Engineering Toolbox v12.1 PRO",
    page_icon="⚙️",
    layout="wide",
...
st.sidebar.markdown("---")
st.sidebar.markdown("<div style='text-align: center; font-size: 0.8rem; color: #777;'>ENGINEERING TOOLBOX v12.1 PRO<br>Streamlit SaaS Web Suite<br>Działa 100% Offline</div>", unsafe_allow_html=True)
...
if menu == "📊 Pulpit Główny":
    st.markdown("<div class='main-header'>ENGINEERING TOOLBOX v12.1 PRO</div>", unsafe_allow_html=True)
    ...
    st.markdown("""
    Witaj w profesjonalnej aplikacji **Engineering Toolbox v12.1 PRO** przeniesionej na silnik **Streamlit**! 

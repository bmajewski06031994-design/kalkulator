...
# Set Page Config
st.set_page_config(
    page_title="Engineering Toolbox v4.0",
    page_icon="⚙️",
    layout="wide",
...
FASTENERS_DB = {
    ...
    "M30": {"nut_s": 46.0, "nut_m": 24.0, "nut_weight": 223.0, "nut_price": 223.0*12.5, "washer_d1": 31.0, "washer_d2": 56.0, "washer_h": 4.0, "washer_weight": 53.6, "washer_price": 53.6*12.5},
    "M36": {"nut_s": 55.0, "nut_m": 29.0, "nut_weight": 393.0, "nut_price": 393.0*12.5, "washer_d1": 37.0, "washer_d2": 66.0, "washer_h": 5.0, "washer_weight": 92.1, "washer_price": 92.1*12.5},
    "M48": {"nut_s": 75.0, "nut_m": 38.0, "nut_weight": 977.0, "nut_price": 977.0*12.5, "washer_d1": 50.0, "washer_d2": 92.0, "washer_h": 8.0, "washer_weight": 294.0, "washer_price": 294.0*12.5}
}
...
# Expanded weights (M30, M36, M48)
M30_LEN_WGTS = [
    (35, 424.0), (40, 448.0), (45, 472.0), (50, 496.0), (55, 519.0),
    (60, 543.0), (65, 566.0), (70, 590.0), (75, 614.0), (80, 637.0),
    (85, 661.0), (90, 685.0), (95, 708.0), (100, 732.0), (110, 779.0),
    (120, 827.0), (130, 874.0), (140, 921.0), (150, 969.0), (160, 1010.0),
    (170, 1060.0), (180, 1110.0), (190, 1160.0), (200, 1210.0)
]
for l, w in M30_LEN_WGTS:
    BOLT_WEIGHTS_DB[f"M30-{l}"] = w

M36_LEN_WGTS = [
    (35, 670.0), (40, 714.0), (45, 748.0), (50, 783.0), (55, 817.0),
    (60, 851.0), (65, 886.0), (70, 910.0), (75, 950.0), (80, 990.0),
    (85, 1020.0), (90, 1060.0), (95, 1100.0), (100, 1140.0), (110, 1200.0),
    (120, 1260.0), (130, 1330.0), (140, 1400.0), (150, 1470.0), (160, 1540.0),
    (170, 1610.0), (180, 1680.0), (190, 1740.0), (200, 1810.0)
]
for l, w in M36_LEN_WGTS:
    BOLT_WEIGHTS_DB[f"M36-{l}"] = w

M48_LEN_WGTS = [
    (40, 1590.0), (45, 1650.0), (50, 1710.0), (55, 1770.0), (60, 1830.0),
    (65, 1890.0), (70, 1950.0), (75, 2010.0), (80, 2080.0), (85, 2140.0),
    (90, 2200.0), (95, 2260.0), (100, 2320.0), (110, 2450.0), (120, 2570.0),
    (130, 2690.0), (140, 2820.0), (150, 2940.0), (160, 3060.0), (170, 3180.0),
    (180, 3310.0), (190, 3430.0), (200, 3560.0)
]
for l, w in M48_LEN_WGTS:
    BOLT_WEIGHTS_DB[f"M48-{l}"] = w

# 4. Bolt Pricing (DIN 933 Approximations in PLN/1000pcs)
BOLT_PRICES_DB = {}
EXISTING_PRICES = {
    "M3-8": 40.21, "M3-10": 43.38, "M3-12": 46.54, "M3-16": 52.7, "M3-20": 59.03, "M3-25": 66.9, "M3-30": 74.69,
    "M4-8": 47.27, "M4-10": 50.94, "M4-12": 54.7, "M4-16": 62.05, "M4-20": 69.48, "M4-25": 78.8, "M4-30": 88.11,
    "M5-50": 149.51, "M6-8": 66.39, "M6-10": 71.68, "M6-12": 76.97, "M6-16": 87.64, "M6-20": 98.3,
    "M6-25": 111.53, "M6-30": 124.84, "M6-40": 151.45, "M6-50": 178.5, "M6-60": 204.95,
    "M8-8": 84.32, "M8-10": 114.35, "M8-12": 122.7, "M8-16": 138.55, "M8-20": 153.55, "M8-25": 173.15,
    "M8-30": 192.75, "M8-40": 231.95, "M8-50": 270.3, "M8-60": 309.5,
    "M10-10": 174.7, "M10-12": 185.6, "M10-16": 207.4, "M10-20": 229.2, "M10-25": 256.45, "M10-30": 283.7,
    "M10-40": 338.2, "M10-50": 392.7, "M10-60": 448.05,
    "M12-10": 235.05, "M12-12": 251.9, "M12-16": 279.65, "M12-20": 312.5, "M12-25": 344.85, "M12-30": 381.45,
    "M12-40": 454.65, "M12-50": 527.0, "M12-60": 591.7,
    "M16-16": 539.75, "M16-20": 588.75, "M16-25": 651.7, "M16-30": 714.65, "M16-40": 839.7, "M16-50": 960.5, "M16-60": 1091.5,
    "M20-16": 936.7, "M20-20": 1018.0, "M20-25": 1109.0, "M20-30": 1200.0, "M20-40": 1390.5, "M20-50": 1581.0, "M20-60": 1763.0,
    "M24-20": 1613.0, "M24-25": 1746.5, "M24-30": 1880.0, "M24-40": 2147.0, "M24-50": 2414.0, "M24-60": 2681.0,
}

for k, v in BOLT_WEIGHTS_DB.items():
    if k in EXISTING_PRICES:
        BOLT_PRICES_DB[k] = EXISTING_PRICES[k]
    else:
        # Calculate pricing piecewise
        if v <= 5.0:
            BOLT_PRICES_DB[k] = round(v * 20.0 + 25.0, 2)
        elif v <= 50.0:
            BOLT_PRICES_DB[k] = round(v * 10.0 + 50.0, 2)
        else:
            BOLT_PRICES_DB[k] = round(v * 8.5 + 100.0, 2)

# 5. Thread Parameters Database
THREAD_PARAMS_DB = {
    ...
    "M30": {"pitch": 3.50, "drill": 26.5, "fine_hole": 31.0, "medium_hole": 33.0, "t_8_8": 1719.0, "t_10_9": 2377.0, "t_12_9": 2774.0, "p_8_8": 292.0, "p_10_9": 422.0},
    "M36": {"pitch": 4.00, "drill": 32.0, "fine_hole": 37.0, "medium_hole": 39.0, "t_8_8": 3290.0, "t_10_9": 4620.0, "t_12_9": 5550.0, "p_8_8": 420.0, "p_10_9": 600.0},
    "M48": {"pitch": 5.00, "drill": 43.0, "fine_hole": 50.0, "medium_hole": 52.0, "t_8_8": 7500.0, "t_10_9": 10500.0, "t_12_9": 12600.0, "p_8_8": 750.0, "p_10_9": 1080.0}
}
...
menu = st.sidebar.radio(
    ...
    [
        ...
        "📐 4. Spadki, Kąty i Belki",
        "⏱️ 5. Kalkulator Czasu Pracy"
    ]
)

# Sidebar footer
st.sidebar.markdown("---")
st.sidebar.markdown("<div style='text-align: center; font-size: 0.8rem; color: #777;'>ENGINEERING TOOLBOX v4.0<br>Zoptymalizowany pod kątem elementów złącznych<br>© 2026 Wszelkie prawa zastrzeżone</div>", unsafe_allow_html=True)
...
if menu == "📊 Pulpit Główny":
    st.markdown("<div class='main-header'>ENGINEERING TOOLBOX v4.0</div>", unsafe_allow_html=True)
    ...
    st.markdown("""
    Witaj w interaktywnej wersji **Engineering Toolbox v4.0**! Jest to nowoczesna aplikacja webowa (SaaS) oparta na silniku Streamlit, 
    która w 100% odzwierciedla dane normatywne i zaawansowane formuły matematyczne zawarte w wersji arkuszowej (Excel).
    
    Wersja 4.0 została zoptymalizowana: usunęliśmy kalkulatory kablowe oraz tolerancji, kładąc nacisk na **maksymalne rozszerzenie bazy elementów złącznych i śrub (aż do rozmiaru M48!)**.
    
    To potężne narzędzie pozwala na natychmiastowe wykonywanie kalkulacji inżynierskich, dobieranie parametrów montażowych oraz szacowanie kosztów 
    surowców, elementów złącznych i pracy ludzkiej bezpośrednio w przeglądarce internetowej.
    """)
    ...
    with col1:
        st.markdown("<div class='card'><h4>🎨 LEGENDA OZNACZEŃ KOLORYSTYCZNYCH</h4>"
                    ...
                    "<li><b>Panele alertów:</b> Sygnalizują potencjalne błędy bądź przekroczenia limitów geometrycznych.</li>"
...
# PAGE 2: ELEMENTY ZŁĄCZNE & COSTING
    ...
    with col_in:
        ...
        length = st.selectbox("Długość śruby L (mm) wg DIN 933:", sorted(avail_lengths), index=0)
    ...
    with col_out:
        ...
        single_set_weight_g = bolt_weight + nut_weight + washer_weight # grams (since kg/1000pcs = g/1pcs)
        ...
        with st.expander("Zobacz zestawienie składowe i rozbicie wagowo-cenowe"):
            df_breakdown = pd.DataFrame({
                "Element": ["Śruba DIN 933", "Nakrętka DIN 934", "Podkładka DIN 125"],
                "Masa 1 szt. (g)": [
                    bolt_weight, 
                    fdata["nut_weight"] if add_nut == "Tak" else 0.0, 
                    fdata["washer_weight"] if num_washers > 0 else 0.0
                ],
                "Masa w zestawie (g)": [
                    bolt_weight, 
                    nut_weight, 
                ...
                "Cena bazowa (PLN/1000szt)": [bolt_price, nut_price, washer_price],
                "Cena efektywna (PLN/1000szt)": [cost_bolt_1000, cost_nut_1000, cost_washer_1000]
            })
...
# PAGE 4: SPADKI, KĄTY I BELKI
elif menu == "📐 4. Spadki, Kąty i Belki":
    st.markdown("<div class='main-header'>📐 4. GEOMETRIA, SPADKI I UGIEĆ BELEK</div>", unsafe_allow_html=True)
    st.markdown("<div class='sub-header'>Szybkie analizy geometryczne konstrukcji ramy oraz obliczenia strzałki ugięcia belek</div>", unsafe_allow_html=True)
    
    tab1, tab2 = st.tabs(["📐 Geometria, Spadki i Kąty", "🌉 Obliczenia Ugięcia Belki"])
    
    with tab1:
        col_g1, col_g2 = st.columns(2)
        with col_g1:
            h_y = st.number_input("Wysokość Y (mm) (pionowy wymiar nachylenia):", min_value=0.0, value=150.0, step=10.0)
            w_x = st.number_input("Szerokość X (mm) (poziomy wymiar nachylenia):", min_value=1.0, value=1000.0, step=100.0)
            
        with col_g2:
            # Trigonometry math
            hypotenuse = math.sqrt(h_y**2 + w_x**2)
            slope_pct = (h_y / w_x) * 100.0
            angle_deg = math.degrees(math.atan(h_y / w_x))
            
            st.markdown(f"\"\"\"\n            <div class='card'>\n                <h4>Wyniki geometryczne</h4>\n                <p><b>Długość boku L (hipotenuza):</b> {hypotenuse:.2f} mm</p>\n                <p style='color: #2F5496; font-size: 1.2rem;'><b>Spadek procentowy:</b> {slope_pct:.2f}%</p>\n                <p style='color: #1F497D; font-size: 1.2rem;'><b>Kąt nachylenia:</b> {angle_deg:.2f}°</p>\n            </div>\n            \"\"\"", unsafe_allow_html=True)
            
    with tab2:
        col_b1, col_b2 = st.columns(2)
        with col_b1:
            support_type = st.selectbox("Schemat podparcia belki:", ["Wspornikowa (Cantilever)", "Swobodne podparcie (Simple Support)"])
            material_beam = st.selectbox("Materiał belki konstrukcyjnej:", list(MATERIALS_DB.keys()))
            force_f = st.number_input("Siła obciążająca skupiona F (N):", min_value=1.0, value=1000.0, step=100.0)
            length_beam = st.number_input("Długość belki L (mm):", min_value=1.0, value=2000.0, step=100.0)
            inertia_ix = st.number_input("Moment bezwładności przekroju Ix (cm⁴):", min_value=0.1, value=100.0, step=10.0)
            
        with col_b2:
            mdata = MATERIALS_DB[material_beam]
            young_pa = mdata["young_gpa"] * 1e9 # GPa to Pa
            inertia_m4 = inertia_ix / 1e8 # cm4 to m4
            length_m = length_beam / 1000.0 # mm to m
            
            # Deflection calculation
            if "Wspornikowa" in support_type:
                deflection_m = (force_f * (length_m**3)) / (3.0 * young_pa * inertia_m4)
            else:
                deflection_m = (force_f * (length_m**3)) / (48.0 * young_pa * inertia_m4)
                
            deflection_mm = deflection_m * 1000.0 # m to mm
            
            st.markdown(f"\"\"\"\n            <div class='card'>\n                <h4>Uproszczona analiza wytrzymałościowa</h4>\n                <p><b>Materiał belki:</b> {material_beam}</p>\n                <p><b>Moduł Younga E:</b> {mdata['young_gpa']} GPa</p>\n                <p><b>Moment bezwładności:</b> {inertia_ix} cm⁴ ({inertia_m4:.8f} m⁴)</p>\n                <br>\n                <div style='font-size: 0.9rem; color: #555;'>Maksymalna strzałka ugięcia belki:</div>\n                <div class='metric-value'>{deflection_mm:.3f} mm</div>\n            </div>\n            \"\"\"", unsafe_allow_html=True)

# PAGE 5: WYCENA CZASU PRACY
elif menu == "⏱️ 5. Kalkulator Czasu Pracy":
    st.markdown("<div class='main-header'>⏱️ 5. KALKULATOR CZASU PRACY & ROBOCIZNY</div>", unsafe_allow_html=True)

...
# Set Page Config
st.set_page_config(
    page_title="Engineering Toolbox v12.3 PRO",
    page_icon="⚙️",
    layout="wide",
...
def get_fasteners_db():
    return {
        ...
        "M48": {"nut_s": 75.0, "nut_m": 38.0, "nut_weight": 977.0, "nut_price": 11700.00, "washer_d1": 50.0, "washer_d2": 92.0, "washer_h": 8.0, "washer_weight": 294.0, "washer_price": 3200.00}
    }
...
st.sidebar.markdown("---")
st.sidebar.markdown("<div style='text-align: center; font-size: 0.8rem; color: #777;'>ENGINEERING TOOLBOX v12.3 PRO<br>Streamlit SaaS Web Suite<br>Działa 100% Offline</div>", unsafe_allow_html=True)
...
if menu == "📊 Pulpit Główny":
    st.markdown("<div class='main-header'>ENGINEERING TOOLBOX v12.3 PRO</div>", unsafe_allow_html=True)
    ...
    st.markdown("""
    Witaj w profesjonalnej aplikacji **Engineering Toolbox v12.3 PRO** przeniesionej na silnik **Streamlit**! 
